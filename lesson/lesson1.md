...
- Реализуйте класс `com.github.m_sulkouski.basejava.resume_app.storage.com.github.m_sulkouski.basejava.resume_app.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.github.m_sulkouski.basejava.resume_app.storage.com.github.m_sulkouski.basejava.resume_app.MainArray.main()` и `com.github.m_sulkouski.basejava.resume_app.MainTestArrayStorage.main()`
...
6. `com.github.m_sulkouski.basejava.resume_app.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
